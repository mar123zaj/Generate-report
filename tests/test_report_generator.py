from report_generator import file_not_exists, change_date_format, country_code, validate_number, validate_percent, has_header
...
class TestHasHeaders:
    ...
    def test_with_headers(self):
        assert has_header('tests/with_headers.csv', 'utf-8') == True

    def test_without_headers(self):
        assert has_header('tests/without_headers.csv', 'utf-8') == False